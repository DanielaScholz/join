...
function alertWrongDate() {
    addClasses('date-required', 'alert-color', 'alert-height');
...
function removeAlertWrongDate() {
    removeClasses('date-required', 'alert-color', 'alert-height');
...
function showConfirmation() {
    removeClasslist('task-added-to-board', 'd-none');
    addClasslist('task-added-to-board', 'slide-in');

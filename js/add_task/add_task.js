...
function addLastOptionClass(i) {
    addClasslist('option-' + i + '-container', 'last-option');
}
...
function showCategoryOptions() {
    for (let i = 0; i < categories.length; i++) {
        removeClasslist('c-option' + i, 'd-none');
        removeClasslist('c-delete-option' + i, 'd-none');
    }
    removeClasslist('create-new-category', 'd-none');
...
function playOpenDropdownAnimation(id) {
    addClasslist(id,'scale-up-ver-top');
    removeClasslist(id,'scale-down-ver-top');
}
...
function playCloseDropdownAnimation(id) {
    removeClasslist(id,'scale-up-ver-top');
    addClasslist(id,'scale-down-ver-top');
}

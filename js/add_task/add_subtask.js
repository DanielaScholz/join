...
function createNewSubtask() {
    addClasslist('icon-plus', 'd-none');
    removeClasslist('close-subtask-icon', 'd-none');
    removeClasslist('border-small', 'd-none');
    removeClasslist('create-subtask-icon', 'd-none');
}
...
function closeNewSubtask() {
    removeClasslist('icon-plus', 'd-none');
    addClasslist('close-subtask-icon', 'd-none');
    addClasslist('border-small', 'd-none');
    addClasslist('create-subtask-icon', 'd-none');
}

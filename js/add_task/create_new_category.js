...
function showColorSelection() {
    removeClasslist('color-selection-container', 'd-none');
}
...
function hideColorSelection() {
    addClasslist('color-selection-container', 'd-none');
}
...
function showNewCategoyAlert() {
    ...
    addClasslist('category-required','alert-color');
}
...
function removeAlerts() {
    removeClasslist('category-options-container','d-none');
    removeClasslist('category-required','alert-color');
    document.getElementById('category-required').innerHTML = 'Please enter a category name first';
}
